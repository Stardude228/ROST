        ...
        <div style={{ marginTop: "100px" }}>
            <Container>
                <Row className="mt-3 justify-content-center">
                    <h3 id="products" className="heading">Xiaomis</h3>
                    <div className="row text-center">
                        {props.data.map((item) => (
                            item.title.toLowerCase() === "xiaomi" ? (<BlockOfProducts item={item}/>):(<div key={item.id}/>)
                        ))}
                    </div>
                </Row>
            </Container>
...
export default connect(mapStateToProps, mapDispatchToProps)(Xiaomi);